---
title: "タスクを自動化するためのタスク シーケンスの管理"
...
Configuration Manager バージョン 1710 以降では、別のタスク シーケンスを実行する新しいタスク シーケンス ステップを追加できます。 これにより、タスク シーケンス間に親子のリレーションシップが作成されます。 これにより、再利用可能なモジュール型のタスク シーケンスをより多く作成できます。
