---
title: "証明書プロファイルの作成 | Microsoft Docs"
...
---
# <a name="how-to-create-scep-certificate-profiles-in-system-center-configuration-manager"></a>System Center Configuration Manager で SCEP 証明書プロファイルを作成する方法
...
証明書プロファイルの作成ウィザード **** の [全般] ページで、次の情報を指定します。  
