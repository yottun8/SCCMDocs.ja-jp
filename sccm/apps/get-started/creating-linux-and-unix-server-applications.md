...
|このプログラムがコンピューターに割り当てられるとき<br /><br /> - サインインしたユーザーごとに 1 回実行する|設定が無視される|ユーザー固有の設定はサポートされていません。<br /><br /> ただし、クライアントでは、コンピューターごとに 1 回実行する構成はサポートされています。<br /><br /> [ プログラムの実行条件ユーザーがログオンしているときのみをサポートします。|  
