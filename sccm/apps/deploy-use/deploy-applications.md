...
>[!Tip]
>バージョン 1702 では、これはプレリリース機能です。 有効にする方法については、「[System Center Configuration Manager のプレリリース機能](https://docs.microsoft.com/sccm/core/servers/manage/pre-release-features)」をご覧ください。
