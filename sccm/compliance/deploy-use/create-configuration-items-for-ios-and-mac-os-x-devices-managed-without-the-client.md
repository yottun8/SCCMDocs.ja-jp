---
title: "System Center Configuration Manager クライアントを使用せずに管理されている iOS デバイスと Mac OS X デバイスの構成項目を作成する | System Center Configuration Manager"
...
|**ロック解除用の指紋**|指紋センサーを使用してデバイスのロックを解除できるようにします。|  
