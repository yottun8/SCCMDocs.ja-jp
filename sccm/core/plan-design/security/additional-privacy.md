...
使用状況データのレベルと設定について詳しくは、「[診断結果と使用状況データ](/sccm/core/plan-design/diagnostics/diagnostics-and-usage-data)」をご覧ください。
...
詳しくは、「[Endpoint Protection](/sccm/protect/deploy-use/endpoint-protection)」をご覧ください。
