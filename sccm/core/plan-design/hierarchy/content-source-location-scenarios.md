---
title: "コンテンツ ソースの場所 | System Center Configuration Manager"
...
System Center Configuration Manager では、クライアントが低速ネットワークでコンテンツを検索する方法と場所を定義するために組み合わせて使用する設定がいくつかサポートされます。 使用可能な組み合わせはクライアントが使用するコンテンツの場所に影響します。また、コンテンツの優先ソースを利用できないときにフォールバックの場所を正しく使用できるかどうかに影響します。  
