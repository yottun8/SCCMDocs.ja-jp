...
System Center Configuration Manager バージョン 1706 では、**基本**、**エンハンス**、**フル**の 3 つのレベルの診断結果と使用状況データが収集されます。 既定では、この機能は、エンハンス レベルに設定されます。 以降のセクションでは、各レベルで収集されるデータについて詳しく説明します。
...
System Center Configuration Manager バージョン 1706 の場合、このレベルには次の情報が含まれます。
