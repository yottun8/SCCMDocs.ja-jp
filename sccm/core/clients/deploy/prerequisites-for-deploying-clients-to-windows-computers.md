...
クライアント プッシュを使用するには、次のセキュリティ アクセス許可が必要です。  
   ...
   -   コレクションとデバイスへのクライアント プッシュ インストールとクエリ:**[コレクション]** オブジェクトの **[リソースの変更]** および **[読み取り]** アクセス許可。  
...
- モバイル デバイス用に登録を構成するには、次のセキュリティのアクセス許可が必要です。  
  ...
  - 登録サイト システムの役割を追加、変更、削除する:**サイト** オブジェクトのアクセス許可の**変更**  
  ...
  - モバイル デバイスをインベントリからワイプまたは削除するには:**コレクション** オブジェクトの**リソースの削除**。  

  - ワイプ コマンドまたは削除コマンドを取り消すには:**コレクション** オブジェクトの**リソースの削除**。  
