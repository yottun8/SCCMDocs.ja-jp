...
6.  ドメインを検索するための探索を構成するには、[ **ドメイン** ] タブをクリックし、[ **ドメイン** ] タブで、次のオプションの 1 つ以上を構成します。  
...
11. 探索の実行スケジュールを構成するには、**[スケジュール]** タブをクリックし、**[スケジュール]** タブで、**[新規]** アイコン ![新規アイコン](media/Disc_new_Icon.gif) をクリックして、ネットワーク探索の実行スケジュールを設定します。  
