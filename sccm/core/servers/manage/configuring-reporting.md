...
5.  レポート サービス ポイントをインストールする前の日付と時刻を指定して、OKをクリックします。 ****  
...
4.  一覧から既定のレポート サーバーを選択して、OKをクリックします。 **** 一覧にレポート サービス ポイントが表示されない場合は、レポート サービス ポイントがサイトに正常にインストールおよび構成されていることを確認します。  
