...
**資産インテリジェンス** カテゴリに表示される 62 件のレポートを次に示します。  
...
**Volume Purchase Program - Apple** カテゴリに表示される 1 件のレポートを次に示します。

|レポート名|説明|  
|-----------------|-----------------|  
|**iOS 向け Apple Volume Purchase Program アプリとライセンス数**|Apple の Volume Purchase Program を通じてライセンスされた iPhone、iPad、iPod Touch アプリケーションがすべて表示されます。 このレポートには、購入済みのライセンスの総数や、アプリケーションごとの利用ライセンス数も含まれます。|  
