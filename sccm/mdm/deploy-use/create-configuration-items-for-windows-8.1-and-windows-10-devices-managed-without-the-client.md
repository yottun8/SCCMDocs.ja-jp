...
||  
|-|  
|この記事には、System Center Configuration Manager \(Current Branch\) の[バージョン 1602 で導入された新しい機能](https://technet.microsoft.com/library/mt622084.aspx)に関する情報が含まれます。 新機能を使用するには、[1602 更新プログラムをインストール](https://technet.microsoft.com/library/mt607046.aspx)する必要があります。 Configuration Manager の最新バージョンに更新していない場合は、TechNet ギャラリーから[使用するバージョンのドキュメントをダウンロード](https://gallery.technet.microsoft.com/Documentation-for-System-ea90eaf1)できます。|  
