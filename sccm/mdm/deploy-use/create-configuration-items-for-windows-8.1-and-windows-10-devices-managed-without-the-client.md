...
---
# <a name="create-configuration-items-for-windows-81-and-windows-10-devices-managed-with-intune"></a>Intune を使用して管理されている Windows 8.1 および Windows 10 デバイスの構成項目を作成する
...
8.  [**デバイスの設定**] ページで、構成する設定グループを選択します。 このトピックの「 [Windows 8.1 と Windows 10 の構成項目設定のリファレンス](#windows-81-and-windows-10-configuration-item-settings-reference) 」で詳細情報を確認し、 **[次へ]**をクリックします。  
