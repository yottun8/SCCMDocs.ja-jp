...
---
# <a name="how-to-create-configuration-items-for-windows-phone-devices-managed-with-intune"></a>Intune を使用して管理されている Windows Phone デバイスの構成項目を作成する方法
...
8.  [**デバイスの設定**] ページで、構成する設定グループを選択します。 このトピックの「[Windows Phone 構成アイテム設定のリファレンス](#windows-phone-configuration-item-settings-reference) 」で詳細情報を確認し、[**次へ**]を選択します。  
