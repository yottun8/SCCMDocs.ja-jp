---
title: "デバイス登録マネージャーと Configuration Manager を使用したデバイスの登録"
...
組織は System Center Configuration Manager と Intune を使って、単一のユーザー アカウントで多数のモバイル デバイスを管理できます。 *デバイス登録マネージャー* アカウントは、5 台を超えるデバイスを登録するためのアクセス許可を持つ特別な Intune アカウントです。  
